...
param subnetName string = 'aci-subnet-win'

@description('Location for all resources.')
param location string = resourceGroup().location

@description('Container group name')
param containerGroupName string = 'aci-containergroup-vnet'

@description('Container name')
param containerName string = 'aci-container-vnet'

@description('Container image to deploy. Should be of the form accountName/imagename:tag for images stored in Docker Hub or a fully qualified URI for a private registry like the Azure Container Registry.')
param image string = 'mcr.microsoft.com/windows/servercore/iis:latest'
